...
export const ProgressRing = ({ progress, size, strokeWidth, mainColor, isDark }: ProgressRingProps) => {
  ...
  return (
    <View style={{ width: size, height: size, justifyContent: 'center', alignItems: 'center' }}>
      ...
      <View style={{ position: 'absolute' }}>
        <Text className={`${isDark ? 'text-white' : 'text-black'} font-jetbrains-mono-bold text-[10px]`}>
          {Math.round(progress)}%
        </Text>
      </View>
    </View>
